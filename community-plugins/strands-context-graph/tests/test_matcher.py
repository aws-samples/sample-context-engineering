...
from strands_context_graph.matcher import EmbeddingSimilarityMatcher, SimilarityMatcher
...
def test_failure_returns_an_empty_sequence_and_logs_once(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level(logging.DEBUG, logger="strands_context_graph.matcher"):
