"""Tests for the pure preview primitives in ``strands_relevance_filter.preview``.
...
from strands_relevance_filter.preview import (
    Chunk,
    RelevancePreview,
    RerankerError,
)
...
# --------------------------------------------------------------------------- #
# Local fake reranker (no conftest.py — another agent owns that file).
# --------------------------------------------------------------------------- #
class FakeReranker:
