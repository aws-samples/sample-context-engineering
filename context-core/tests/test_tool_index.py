"""Property tests for the neutral tool search index (ported from the Strands plugin suite, read-only reference).
...
from context_core.disclosure.tool_index import LexicalToolIndex, ToolIndex, ToolMatch
